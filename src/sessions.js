...
const { baseWebhookURL, sessionFolderPath, maxAttachmentSize, setMessagesAsSeen, webVersion, webVersionCacheType, recoverSessions, chromeBin, headless, releaseBrowserLock, proxyUrl, proxyUsername, proxyPassword, mongodbUri } = require('./config')
...
const initializeEvents = (client, sessionId) => {
  ...
  client.on('remote_session_saved', () => {
    logger.info({ sessionId }, 'Remote session saved successfully to MongoDB')
  })
